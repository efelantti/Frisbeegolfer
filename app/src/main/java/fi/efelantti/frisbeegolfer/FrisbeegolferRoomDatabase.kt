...
@Database(entities = arrayOf(Player::class, Course::class, Hole::class, Round::class, Score::class), version = 11, exportSchema = false)
    ...
    companion object {
        ...
        fun getDatabase(
            ...
            synchronized(this) {
                ...
                ).addCallback(FrisbeegolferDatabaseCallback(scope)).fallbackToDestructiveMigrationFrom(10).build()
                INSTANCE = instance
                return instance
            }
        }
